...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            @endif
            <a href = "{{ route('show.categoria') }}" class = "btn btn-success">Cadastrar Categoria</a>
                ...
                @foreach($categorias as $categoria)
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            ...
                            <button class="btn btn-danger btn-sm remove" id = "{{ $categoria->id_categoria }}" data-toggle="modal" data-target="#exampleModal">
