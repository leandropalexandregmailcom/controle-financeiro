...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            @endif
            <a href = "{{ route('show.despesa') }}" class = "btn btn-success">Cadastrar Despesa</a>
            ...
            <tbody>
                @foreach($despesas as $despesa)
                    <tr>
                        ...
                        <td style = "width: 10%;">
                            <a>
                                {{ \Carbon\Carbon::parse($despesa->date)->format('d/m/Y') }}
                            </a>
                        </td>
                        <td class="project-actions text-right">
                            ...
                            <button class="btn btn-danger btn-sm remove" id = "{{ $despesa->id_despesa }}" data-toggle="modal" data-target="#exampleModal">
